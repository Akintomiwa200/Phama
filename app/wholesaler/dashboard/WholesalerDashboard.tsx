...
import { RevenueChart, TopItemsList } from '@/components/charts';
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={today ? `Performance overview — ${today}` : 'Performance overview'}
        actions={
        ...
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Incoming bulk orders from retailers
            </p>
          </div>
          <Link
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              ...
              label: 'Items',
              render: (r) => (
                <span className="text-sm">{r.items?.length} SKU(s)</span>
              ),
            },
            {
              key: 'total',
            ...
            },
            {
              ...
              label: 'Payment',
              render: (r) => (
                <StatusBadge status={r.payment?.status || 'pending'} />
              ),
            },
            {
              key: 'status',
              label: 'Status',
              render: (r) => <StatusBadge status={r.status} showIcon />,
            },
            {
              key: 'createdAt',
              label: 'Date',
